    ...
    return (
        <section className="container-center py-[26px]">
            ...
            <div className="grid grid-cols-12 items-center">
                <div className="col-span-6 flex items-center gap-4 md:col-span-4 lg:col-span-3 lg:hidden">
                    <SearchProcesses />
                    <NavbarSidebarWButton />
                </div>

                <div className="col-span-6 mx-auto hidden flex-1 justify-center md:col-span-4 md:flex lg:col-span-3 lg:mx-0 lg:justify-start">
                    <Image src={'/bokifa-logo.webp'} alt="bokifa logo" width={150} height={37} />
                </div>

                <div className="col-span-6 mx-auto hidden w-full max-w-[1050px] items-center justify-center px-5 lg:flex">
                    <SearchProcesses />
                </div>

                <div className="col-span-6 flex items-center justify-end gap-1 md:col-span-4 lg:col-span-3">
